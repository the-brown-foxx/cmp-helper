...
// This is a LivePlugin plugin that makes a shortcut for making a Compose Preview
// in the androidMain sourceSet for Composables in commonMain to leverage Android's
// better previews.
// To use, load this plugin to LivePlugin.
// Open the related Composable file and press Alt + A.
